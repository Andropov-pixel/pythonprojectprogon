...
def test_filter_by_state_1(test_initial_list_1):
    assert filter_by_state(initial_list) == [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
                                             {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'}]

def test_filter_by_state_sort(test_initial_list_1):
    assert sort_by_date(initial_list) == [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
